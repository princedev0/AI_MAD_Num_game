...
be performance values. The getSlope method is a static method, so you won't to need to create objects of the LR class to obtain slope. Just use the name of the class LR.
